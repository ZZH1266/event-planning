        ...
        <el-row :gutter="20">
            ...
            <el-col :span="24" :xs="24">
                ...
                <el-row style="padding-bottom: 10px">
                    <el-button type="primary" icon="el-icon-new" size="mini" @click="createActivity">新增资源</el-button>
                </el-row>
                ...
                <el-table v-loading="loading" :data="actList" @selection-change="handleSelectionChange">
                    ...
                    <el-table-column label="资源描述" align="center" key="description" prop="description"/>
